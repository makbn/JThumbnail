...
public abstract class AbstractThumbnailer implements Thumbnailer {
    ...
    /**
     * This function will be called after all Thumbnails are generated. Note:
     * This acts as a Deconstructor. Do not expect this object to work after
     * calling this method.
     *
     ...
     * You should override this method in order to give hints when which
     * Thumbnailer is most appropriate. If you do not override this method, the
     * Thumbnailer will be called in any case - awaiting a ThumbnailException if
     * this thumbnailer cannot treat such a file.
     *
     * @return an array of MIME Types. If null, all Files may be passed to this
     * Thumbnailer.
     */
    ...
    /**
     * Generate a Thumbnail of the input file. (You can override this method if
     * you want to handle the different MIME-Types).
     *
